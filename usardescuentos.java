 ...
 * @author dilmergo
 */
public class usardescuentos extends javax.swing.JFrame {
    
    private int idDescu;
    private int porceDescu;

    public usardescuentos(int idDescu, int porceDescu) {
        this.idDescu = idDescu;
        this.porceDescu = porceDescu;
    }
    
    ArrayList<usardescuentos> descuentos = new ArrayList<>();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(usardescuentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new usardescuentos().setVisible(true);
            }
        });
    }
